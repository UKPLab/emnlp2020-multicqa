...
from . import adapter
from .adapter import BertAdapterAttention
...
class BertAttention(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask, head_mask=None, tasks=None):
...
class BertOutput(nn.Module):
    ...
    def add_attention_layer(self, task_names, attention_type):
    ...
    def add_adapter(self, task_name, downsample=None):
    ...
    def forward(self, hidden_states, input_tensor, attention_mask, tasks=None):
        hidden_states = self.dense(hidden_states)
        hidden_states = self.dropout(hidden_states)
...
class BertLayer(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, head_mask=None, tasks=None):
...
class BertModel(BertPreTrainedModel):
    ...
    def add_adapter(self, task_name, downsample):
